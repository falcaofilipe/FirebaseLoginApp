...
import login.com.example.filipe.firebaseloginapp.Adapter.FeedAdapter;
import login.com.example.filipe.firebaseloginapp.Common.HTTPDataHandler;
import login.com.example.filipe.firebaseloginapp.Model.RSSObject;
...
public class RssActivity extends Activity {
    ...
    private final String RSS_link="https://noticias.r7.com/saude/feed.xml";
    //Padrão de projeto:
    //Padrões de criação
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Rss Feed Noticias.R7 Saúde");
